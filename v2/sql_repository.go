...
type SQLRepository[K comparable, T any] interface {
...
func (r *sqlRepository) GetTableDef() SQLTableDef {
	return r.tableDef
}

func (r *sqlRepository) modelTagExists(name string) bool {
	_, ok := r.modelTags[strings.ToUpper(name)]
	return ok
}

func (r *sqlRepository) createFieldsAndValuesMapFromModelType(value any, fieldTag string) (map[string]any, error) {
